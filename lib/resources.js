...
//                        'rt.llamada_automatica, rt.iControlTmLlam, rt.iTmMaxConversacion, rt.RespuestaSIP_ATSR2, rt.TmTonoBloqueo, TmBloqueoLib, timeout_respuesta_SIP, p.ip_virtual ' +
                        'rt.llamada_automatica, rt.iControlTmLlam, rt.iTmMaxConversacion, rt.RespuestaSIP_ATSR2, rt.TmTonoBloqueo, rt.TmBloqueoLib, p.ip_virtual ' +
                        ...
                        function (err, rows) {
                            if (err) {
                                ...
                                /** 20221019. Nuevo parametro para linea telefonica */
                                recurso.telefonia.llamada_automatica = rows[0].llamada_automatica;
                                ...
                                // recurso.telefonia.timeout_respuesta_SIP = rows[0].timeout_respuesta_SIP;
                                recurso.telefonia.timeout_respuesta_SIP = 0;
            ...
            var importDataResource = function (callback) {
                var query = connection.query('INSERT INTO recursos_telefono (pasarela_id,fila,columna,nombre,codec, ' +
                    ...
                    [gtwId, row, column, resource.IdRecurso, resource.Codec,
                        ...
                        resource.Llamada_automatica,
                        resource.telefonia.iTmMaxConversacion, resource.telefonia.iControlTmLLam,
                        resource.telefonia['RespuestaSIP-ATSR2'], resource.telefonia.TmTonoBloqueo,
