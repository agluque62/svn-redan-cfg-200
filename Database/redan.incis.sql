...
-- Volcando datos para la tabla ug5kv2.incidencias: ~88 rows (aproximadamente)
DELETE FROM `incidencias`;
/*!40000 ALTER TABLE `incidencias` DISABLE KEYS */;
INSERT INTO `incidencias` (`IdIncidencia`, `Incidencia`, `Descripcion`, `LineaEventos`, `Grupo`, `Error`, `Nivel`) VALUES
	...
	(50, '{LOGIN_CENTRALIZED_TEXT}', '{LOGIN_CENTRALIZED}', 1, '{SECURITY}', 0, 1),
	(51, '{REJECT_SESSION_TEXT}', '{REJECT_SESSION}', 1, '{SECURITY}', 0, 2),
	(52, '{USER_REGISTERED_TEXT}', '{USER_REGISTERED}', 0, '{SECURITY}', 0, 0),
	(53, '{USER_DELETED_TEXT}', '{USER_DELETED}', 0, '{SECURITY}', 0, 0),
	(54, '{USER_MODIFIED_TEXT}', '{USER_MODIFIED}', 0, '{SECURITY}', 0, 0),
	(55, '{END_SESSION_TEXT}', '{END_SESSION}', 1, '{SECURITY}', 0, 1),
	(101, '{CONFIG_CREATE_TEXT}', '{CONFIG_CREATE}', 0, 'CONF-R', 0, 0),
	(102, '{CONFIG_DELETE_TEXT}', '{CONFIG_DELETE}', 0, 'CONF-R', 0, 0),
	(103, '{CONFIG_UPDATE_TEXT}', '{CONFIG_UPDATE}', 0, 'CONF-R', 0, 0),
	...
	(107, '{GATEWAY_CREATE_TEXT}', '{GATEWAY_CREATE}', 0, 'CONF-R', 0, 0),
	(108, '{GATEWAY_DELETE_TEXT}', '{GATEWAY_DELETE}', 0, 'CONF-R', 0, 0),
	(109, '{GATEWAY_UPDATE_TEXT}', '{GATEWAY_UPDATE}', 0, 'CONF-R', 0, 0),
	(110, '{GATEWAY_UPDATE_PARAM_TEXT}', '{GATEWAY_UPDATE_PARAM}', 0, 'CONF-R', 0, 0),
	(113, '{RESOURCE_CREATE_TEXT}', '{RESOURCE_CREATE}', 0, 'CONF-R', 0, 0),
	(114, '{RESOURCE_DELETE_TEXT}', '{RESOURCE_DELETE}', 0, 'CONF-R', 0, 0),
	(115, '{RESOURCE_UPDATE_TEXT}', '{RESOURCE_UPDATE}', 0, 'CONF-R', 0, 0),
